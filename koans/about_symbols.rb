...
class AboutSymbols < Neo::Koan
  ...
  def test_method_names_become_symbols
    symbols_as_strings = Symbol.all_symbols.map { |x| x.to_s }#enumerable object
  ...
  #Answers: use symbols if possible as opposed to strings because ruby creates a different 
#object_id  and allocates memeory for each
